...
namespace NF.IrrigationController.ESP32
{
    ...
    class HttpWebServer : IDisposable
    {
        ...
        /// </summary>
        public HttpWebServer(string SSID, string Password )
        {
            _SSID = SSID;
            ...
            Debug.WriteLine("Time " + DateTime.UtcNow.ToString());
            ...
            Debug.WriteLine("Added " + ZoneTimer.TimeOffSet.ToString());
        ...
        private void ConnectNetwork()
        {
            ...
            if (nis.Length > 0)
            {
                ...
                if (ni.NetworkInterfaceType == NetworkInterfaceType.Wireless80211)
                {
                    ...
                    Debug.WriteLine("Password " + wc.Password);
                    Debug.WriteLine("SSID " + wc.Ssid);
                ...
                if (ni.IPv4Address != null && ni.IPv4Address.Length > 0)
                {
                    ...
                    if (ni.IPv4Address[0] != '0')
                    {
                       ...
                       // Debug.WriteLine($"We have an IP: {ni.IPv4Address}");
                        ...
                        Program.oled.Write(2, 2, "IP " + ni.IPv4Address.ToString());
                                               
                        string macString = BitConverter.ToString(ni.PhysicalAddress);

                        // Debug.WriteLine($"Mac address: {macString}");
